...
public class rootServer {
    ...
    public static void main(String[] args) throws IOException {
        ...
        serverSocket = new DatagramSocket(2221);
        while (true) {
            try {
                ...
                String toSend = getRoot(clientdata);
                System.out.println(" toSend " + toSend);

                if (toSend.equals("notFound")) {
                    System.out.println("Entered if condition not");
                    DatagramSocket serverSocket2 = new DatagramSocket(3333);
                    ...
                    DatagramPacket sendPacket2 = new DatagramPacket(sendbuffer2, sendbuffer2.length, IP, 3331);
    ...
    public static String getRoot(String receive) throws IOException {
        String toSend = "notFound";
        try (RandomAccessFile local = new RandomAccessFile("root_dns_table.txt", "r")) {
            while (true) {
